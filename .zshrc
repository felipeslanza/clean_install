...
alias cprof='ipython -m cProfile -- -s cumtime'
...
# Networking
alias iploc="ifconfig | grep broadcast | awk '{print \$2}'"
alias ippub="curl -fs ipinfo.io | grep '\"ip\"' | awk '{print \$2}' | tr -d '\"|,'"
